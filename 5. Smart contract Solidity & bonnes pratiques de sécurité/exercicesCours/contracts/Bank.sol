...
// Demonstrate force feeding: using self-destruct, the attacker can get all the funds of the 
contract Bank {
    ...
    function withdrawAll() public {
        require(msg.sender == owner);
				require(address(this).balance == 10 ether); // change to >= 10 to avoid force feeding
