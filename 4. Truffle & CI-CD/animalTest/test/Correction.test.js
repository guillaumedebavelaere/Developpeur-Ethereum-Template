...
contract('Spa', accounts => {
    ...
    describe.only("test du set et delete", function () {
    ...
    describe("test du adopt", function () {
        ...
        it.only("should adopt normaly, POV OWNER", async () => {
